    ...
    */
    ...
    document.addEventListener('click', function (event) {
      ...
      //Adding workout exercise to list
        ...
        console.log(event.target.parentElement.nextSibling.querySelector("#guidePlaceHolder").firstChild);
        console.log(event.target.parentElement.parentElement.parentElement.nextSibling.querySelector("#guidePlaceHolder").firstChild);
      ...
      } else if(event.target.id == "workoutSummary") { //Need to add id's of text as well
    ...
    async function sendWorkoutToMake(workout) {
      ...
      if(editWorkout == "true") {
        console.log("Why entering in here ?");
